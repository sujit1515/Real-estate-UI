        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
          <div className="flex h-14 sm:h-16 items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-0 lg:space-x-1">
              ...
              {/* Divider */}
              <div className={`h-5 lg:h-6 w-px mx-1 lg:mx-2 ${isScrolled ? 'bg-white/30' : 'bg-white/30'}`}></div>

              {/* Login Button - Responsive padding */}
              <button className="px-4 lg:px-6 py-1.5 lg:py-2 text-xs lg:text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-md hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-md transform hover:-translate-y-0.5 active:scale-95">
                Login
              </button>
            </div>
            ...
            <div className="md:hidden flex items-center space-x-1 sm:space-x-2">
              <button className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-md hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 cursor-pointer shadow-sm active:scale-95">
                Login
              </button>
              <button 
        ...
        >
          <div className="container mx-auto px-4 py-3 sm:py-4 h-full overflow-y-auto">
            <div className="space-y-1 sm:space-y-2">
              ...
              {/* Additional mobile-only CTA */}
              <div className="pt-3 sm:pt-4 mt-3 sm:mt-4 border-t border-white/10">
                <button className="w-full py-2.5 sm:py-3 text-sm sm:text-base font-medium text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 cursor-pointer shadow-sm active:scale-95">
                  Create Account
                </button>
              </div>
            </div>
