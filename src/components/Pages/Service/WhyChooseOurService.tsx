// components/Services/WhyChooseOurServices.tsx
"use client";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              <motion.div
                key={index}
                className="bg-white rounded-xl sm:rounded-2xl p-6 xs:p-7 sm:p-8 border border-gray-200 hover:border-purple-300 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
              ...
              >
                <div className="bg-purple-50 w-12 h-12 xs:w-14 xs:h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mb-4 sm:mb-5 border border-purple-200">
