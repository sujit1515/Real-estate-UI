            ...
            return (
              ...
              >
                {index < processSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-16 left-[60%] w-full h-0.5 bg-gradient-to-r from-purple-400 to-purple-200 z-0" />
                )}

                <div className="relative bg-white rounded-2xl sm:rounded-3xl p-6 xs:p-7 sm:p-8 border border-gray-200 hover:border-purple-300 transition-all duration-300 hover:-translate-y-2 shadow-sm hover:shadow-xl z-10">
