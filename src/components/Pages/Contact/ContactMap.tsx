      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-3 sm:mb-4">
            Visit Our <span className="text-purple-600">Office</span>
          </h2>
        ...
        >
          ...
          <div className="p-6 xs:p-7 sm:p-8 bg-gradient-to-t from-gray-50 to-transparent">
            <div className="max-w-2xl">
              <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">
                Our Office
              </h3>
              <p className="text-gray-600 text-sm xs:text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
