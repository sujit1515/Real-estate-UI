...
export default function EarlyAccessSection() {
  ...
  return (
    <motion.section
      ...
      className="w-full bg-[#eeede9] py-8 md:py-16 px-4 md:px-10 lg:px-16"
    >
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="relative rounded-2xl overflow-hidden px-8 md:px-16 py-12 md:py-16"
          style={{ backgroundColor: "#0f1c2e" }}
        >
          {/* Decorative wave lines with animation */}
          <motion.svg
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <motion.path
              ...
              d="M0 110 Q300 10 600 110 T1200 110"
              stroke="#c9a84c"
              strokeWidth="0.75"
            />
            <motion.path
              ...
              d="M0 230 Q300 130 600 230 T1200 230"
              stroke="#c9a84c"
              strokeWidth="0.5"
            />
          </motion.svg>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-16">
            ...
            >
              <h2 className="font-serif text-white text-3xl md:text-4xl font-semibold leading-tight mb-4">
                Gain early access to off-market listings.
              </h2>
              <p className="text-white/60 text-sm md:text-base leading-relaxed">
                Join our exclusive circle of curators and receive bespoke property recommendations before they hit the public market.
              </p>
            </motion.div>
