...
export default function ListingForm() {
  ...
  return (
    <section className="bg-gradient-to-b from-[#1a1a2e] to-[#252544] py-12 md:py-16">
...
function SectionTitle({ number, title }: { number: string; title: string }) {
  return (
    <h2 className="font-serif text-[20px] font-bold text-white">
      <span className="text-gray-300 font-normal mr-1">{number}.</span> {title}
    </h2>
  );
}
...
function FieldLabel({ children }: { children: React.ReactNode }) {
  return (
    <label className="block text-[11px] font-semibold tracking-[0.1em] uppercase text-gray-300 mb-1.5">
      {children}
    </label>
  );
}
