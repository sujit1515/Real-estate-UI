// components/Renovation/RenovationCTA.tsx
"use client";
...
export default function RenovationCTA() {
  ...
  const handleSubmit = () => {
    if (email.trim()) {
      router.push("/contact?service=renovation");
    }
  };
  ...
  return (
    <section className="py-12 xs:py-14 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-purple-600 to-purple-800 p-8 md:p-12 text-center">
          <div className="relative z-10">
            ...
            <p className="text-purple-100 text-sm xs:text-base sm:text-lg mb-6 max-w-2xl mx-auto">
              Get a free consultation and quote from our renovation experts
            </p>
            ...
            <p className="text-purple-200 text-xs mt-4">
              No obligation. Free consultation & site visit
            </p>
          </div>
        </div>
      </div>
